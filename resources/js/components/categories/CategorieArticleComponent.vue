<template>
        <div class="row">
                ...
                <div class="fixed-action-btn">
                        <a class="btn-floating tooltipped btn-large teal darken-3 modal-trigger" href="#modalarticle" data-position="left" data-tooltip="Novo!" @click="newRoute()">
                                <i class="large material-icons">add</i>
                        </a>
                </div>

           <h5 class="header grey-text center-align">Categorias de artigo</h5>
           <!-- Modal Structure -->
                    ...
                    <tbody v-if="categories.length > 0">
                        <tr v-for="(categorie, index) in categories" :key="index">
                            ...
                            <td class="row">
                                ...
                                <a class="red-text" href="#" @click.prevent="confirmDelete(categorie.id_categoria_artigo, categorie.nome)"><i class="material-icons">delete</i></a>
                            </td>
                        </tr>
                    </tbody>
                    <tbody v-else>
...
export default {
        ...
        methods: {
                ...
                getCategories(){
                        ...
                        axios.get("categorias/artigo/all")
                ...
                deleteCategorie(id){
                        let vm = this
                        axios.delete(`categorias/artigo/delete/${id}`)
                                .then(function(response){
                ...
                loadForm(categorie){
                        ...
                        this.route = 'categorias/artigo/update'
                },
                newRoute(){
                        this.route = 'categorias/artigo/create'
                        this.update = false
